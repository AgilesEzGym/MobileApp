                              ...
                              Container(
                                ...
                                child: const Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'Prueba gratuita de 1 semana para nuevos usuarios, '
                              ...
                              Container(
                                ...
                                child: const Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'Ahorra dos meses de suscripcion disfruta la aplicacion por un anio entero '
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stepper(
        ...
        onStepContinue: () {
          if ((_keyForm.currentState!.validate() && _currentStep == 0) ||
              (isChecked && _currentStep == 1)) {
